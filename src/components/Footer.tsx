        ...
        <div slot="content-top" className="foot-container">
          ...
          <div>
            <div className="button-wrapper">
              ...
              >
                Till toppen
                <DigiIconArrowUp slot="icon-secondary"></DigiIconArrowUp>
              </DigiButton>
              <DigiButton
                af-size="medium"
                af-variation="primary"
              ...
              >
                Länk till jobbsidan
                <DigiIconArrowRight slot="icon-secondary"></DigiIconArrowRight>
              </DigiButton>
            </div>
          </div>
        </div>
          ...
          <address>
            <ul>
              ...
              <li>
                ...
                <a href="mailto:kontakt@foretagsnamn.se">
                  kontakt@foretagsnamn.se
                </a>
              </li>
            </ul>
          </address>
