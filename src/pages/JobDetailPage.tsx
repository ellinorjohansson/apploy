...
export const JobsDetailPage = () => {
  ...
  const hasCompleteRegionInfo = (
    ...
    return (
      !!address && shouldShow(address.region) && shouldShow(address.country)
    );
  };
        ...
        <section className="main-wrapper">
          <div className="headline-wrapper">
            <img
              ...
              src={job.logo_url}
              alt={`Logotyp for ${job.employer?.name || 'the employer'}`}
            />
            <h2>{job.headline}</h2>
          </div>
